 ...
 <a href="index.html">
               ...
               <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div className="search_icon">
                     <ul>
                      <li><a href="#"><img src={Images.search_icon}/></a></li> 
                        <li>
                           <a href="#">LOGIN</a>
                           </li>
                     </ul>
               ...
               <div className="row">
                  <div className="col-md-6">
                     <div className="container_main">
                       <img src={Images.img_2} alt="Avatar" className="image"/>
                  ...
                  <div className="col-md-6">
                     <div className="container_main">
                      <img src={Images.img_3} alt="Avatar" className="image"/> 
                        <div className="overlay">
                          <a href="#" className="icon" title="User Profile"> 
                           <i className="fa fa-search"></i>
                         </a>  
                           ...
                           <div className="row">
                              <div className="col-sm-4">
                                 <div className="container_main1">
                                    <img src={Images.img_4} alt="Avatar" className="image" />
                              ...
                              <div className="col-sm-4">
                                 <div className="container_main1">
                                  <img src={Images.img_5} alt="Avatar" className="image" />
                                    <h1 className="modern_text">Modern home designe</h1>
                                    <div className="middle">
                                       <div className="text">VIEW MORE</div>
                                    </div>
                     ...
                     <div className="projects_section2">
                        <div className="container_main1">
                           <div className="row">
                              ...
                              <div className="col-sm-4">
                                 <div className="container_main1">
                                    <img src={Images.img_6} alt="Avatar" className="image"/>
                                    <h1 className="modern_text">Modern home designe</h1>
                                    <div className="middle">
                                       <div className="text">VIEW MORE</div>
                                    </div>
                           ...
                           <div className="row">
                              <div className="col-sm-3">
                                 <div className="image_7">
                                   <img src={Images.img_7}/>  
                                  </div>
                                 <div className="quote_icon">
                            <img src={Images.quote_icon}/> 
                                  </div>
                              </div>
                  ...
                  <div className="carousel-item">
                     ...
                     <div className="clients_section2 layout_padding">
                        <div className="client_1">
                           <div className="row">
                              <div className="col-sm-3">
                                 <div className="image_7"><img src={Images.img_7}/></div>
                                 <div className="quote_icon"><img src={Images.quote_icon}/></div>
                              </div>
                              <div className="col-sm-9">
                                 <h1 className="loksans_text">loksans</h1>
                                 <p className="dolor_ipsum_text">ipsum dolor sit amet, consectetur adipiscing elit, sed  veniam, quis nostrud exercitation ullamco laboris nisi ut reprehenderit in voluptate velit</p>
                        ...
                        <div className="client_2">
                           <div className="row">
                              <div className="col-sm-3">
                             <div className="image_7"><img src={Images.img_8}/></div>
                                 <div className="quote_icon"><img src={Images.quote_icon}/></div>  
                              </div>
                              <div className="col-sm-9">
                                 <h1 className="loksans_text">loksans</h1>
